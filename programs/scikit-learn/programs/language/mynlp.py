...
X_test = pd.Series(["Is it going to rain today", "switch on the living room fan"])
...
print("Prediction using Pipeline 2: >> ", predicted2)
print("Performance of Pipeline 2: >> ", np.mean(predicted2 == Y_test))
